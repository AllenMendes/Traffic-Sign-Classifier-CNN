...
I chose 12 German traffic signs that I found on the web:
...
I was pretty amazed to see that the model accurately guessed all the 12 test images with 100% accuracy. You can see in the predictions (1st,2nd and 3rd guesses) section how the model pick out the its guesses for each of the input test images from the validation set.

#### 3. Describe how certain the model is when predicting on each of the five new images by looking at the softmax probabilities for each prediction. Provide the top 5 softmax probabilities for each image along with the sign type of each probability. 

As seen from the above result, the model predicted all the images with 100% accuracy. I even included a 2nd and 3rd guess result based on the softmax probablity values. If you observe closely the below few predictions, you can see that model is trying to co relate shapes of Arrow signs and circular boundary traffic signs to th einput images to make a correct predictions.
